...
//-------------------------------------CONSULTA PESTAÑA 2: DATOS DE PADRE Y MADRE-------------------------------------------
    public DefaultTableModel AnamnesisDPM(String ID) {
        ...
        String sql = "SELECT\n"
                ...
                + "END),\n"
                + "(CASE \n"
                + "WHEN anam.edad_madre IS NULL THEN 0\n"
                + "ELSE anam.edad_madre\n"
                + "END),\n"
                + "(CASE\n"
                ...
                + "END ),\n"
                + "(CASE \n"
                + "WHEN pa.edad IS NULL THEN 0\n"
                + "ELSE pa.edad\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN hij.padre_agresor IS true THEN 'SI'\n"
                + "WHEN hij.padre_agresor IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
...
//-------------------------------------CONSULTA PESTAÑA 3: COMPOSICION FAMILIAR-------------------------------------------
    public DefaultTableModel AnamnesisCF(String ID) {
        ...
        String sql = "SELECT  \n"
                ...
                + "END), \n"
                + "(CASE \n"
                + "WHEN (select par_valores->p.persona_estadocivil->>'valor' from parametros where par_id = 4) IS NULL THEN ''\n"
                + "ELSE (select par_valores->p.persona_estadocivil->>'valor' from parametros where par_id = 4)\n"
                + "END) AS \"Estado civil\",\n"
                + "(CASE \n"
                ...
                + "END), \n"
                + "(CASE \n"
                + "WHEN (select par_valores->p.persona_ocupacion->>'valor' from parametros where par_id = 7) IS NULL THEN ''\n"
                + "ELSE (select par_valores->p.persona_ocupacion->>'valor' from parametros where par_id = 7)\n"
                + "END) AS \"Ocupacion\",\n"
                + "(CASE \n"
                + "WHEN f.edad IS NULL THEN 0\n"
                + "ELSE f.edad\n"
                + "END), \n"
                + "(CASE \n"
                + "WHEN (select par_valores->p.persona_nivel_acad->>'valor' from parametros where par_id = 5) IS NULL THEN ''\n"
                + "ELSE (select par_valores->p.persona_nivel_acad->>'valor' from parametros where par_id = 5)\n"
...
//-------------------------------------CONSULTA PESTAÑA 8: DESARROLLO MOTOR--------------------------------------------
    public DefaultTableModel AnamnesisDM(String ID) {
        ...
        String sql = "SELECT\n"
                + "(CASE\n"
                + "WHEN d.des_motor_grueso IS NULL THEN ''\n"
                + "ELSE d.des_motor_grueso\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.des_motor_fino IS NULL THEN ''\n"
                + "ELSE d.des_motor_fino\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.movimientos IS NULL THEN ''\n"
                + "ELSE d.movimientos\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.des_psico_social IS NULL THEN ''\n"
                + "ELSE d.des_psico_social\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.des_cognitivo IS NULL THEN ''\n"
                + "ELSE d.des_cognitivo\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.des_fisico IS NULL THEN ''\n"
                + "ELSE d.des_fisico\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.caridad_lenguajes IS NULL THEN ''\n"
                + "ELSE d.caridad_lenguajes\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN d.claridad_lenguajes_descrip IS NULL THEN ''\n"
                + "ELSE d.claridad_lenguajes_descrip\n"
                + "END)\n"
                + "FROM anamnesis anam\n"
...
//-------------------------------CONSULTA PESTAÑA 9: SUEÑO Y CONTROL DE ESFINTERES------------------------------------------
    public DefaultTableModel AnamnesisSCE(String ID) {
        ...
        String sql = "SELECT\n"
                ...
                + "WHEN sce.duerme_toda_noche IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN sce.miedo_dormir_solo IS true THEN 'SI'\n"
                + "WHEN sce.miedo_dormir_solo IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                ...
                + "WHEN 	sce.pesadillas IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "sce.edad_control_esfinter,\n"
                + "(CASE\n"
                + "WHEN sce.ayuda_bano IS true THEN 'SI'\n"
                + "WHEN sce.ayuda_bano IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + " END),\n"
                + "(CASE\n"
                + "WHEN sce.moja_cama IS true THEN 'SI'\n"
                + "WHEN sce.moja_cama IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN sce.incontrol_esfin_anal IS true THEN 'SI'\n"
                + "WHEN sce.incontrol_esfin_anal IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
...
//-------------------------------CONSULTA PESTAÑA 10: ESCOLARIZACION NNA------------------------------------------
    ...
    public DefaultTableModel AnamnesisENNA(String ID) {
        ...
        String sql = "SELECT\n"
                ...
                + "WHEN es.esc_estudia IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN es.esc_explicacion IS NULL THEN ' '\n"
                + "ELSE es.esc_explicacion\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN es.esc_repeticion_anio_causas IS NULL THEN ' '\n"
                + "ELSE es.esc_repeticion_anio_causas\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN es.esc_nna_problem_aprend IS true THEN 'SI'\n"
                + "WHEN es.esc_nna_problem_aprend IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN es.esc_nna_observaciones IS NULL THEN ' '\n"
                + "ELSE es.esc_nna_observaciones\n"
                + "END), \n"
                + "(CASE\n"
                + "WHEN es.esc_asis_prog_apoyo IS true THEN 'SI'\n"
                + "WHEN es.esc_asis_prog_apoyo IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN es.esc_asis_prog_apoyo_obser IS NULL THEN ' '\n"
                + "ELSE es.esc_asis_prog_apoyo_obser\n"
                + "END),\n"
                + "(CASE\n"
                + " WHEN es.esc_estado IS true THEN 'SI'\n"
                + " WHEN es.esc_estado IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN es.esc_ultimo_anio_cursado IS NULL THEN ' '\n"
                + "ELSE es.esc_ultimo_anio_cursado\n"
                + "END)\n"
        ...
        try {
            ...
            ResultSet res = conn.query(sql);
            String[] cabecera = {"Estudia", "Explicación Escolaridad", "Causas repetición año", "Tiene problemas de aprendizaje", "Observaciones",
...
//---------------------------------------CONSULTA PESTAÑA 11: SALUD NNA--------------------------------------------------
    ...
    public DefaultTableModel AnamnesisSNNA(String ID) {
        ...
        String sql = "SELECT \n"
                + "(CASE\n"
                + "WHEN s.problem_familiar IS NULL THEN ''\n"
                + "ELSE s.problem_familiar\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_familiar_descrip IS NULL THEN ''\n"
                + "ELSE s.problem_familiar_descrip\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_respiratorio IS true THEN 'SI'\n"
                + "WHEN s.problem_respiratorio IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_resp_descrip IS NULL THEN ''\n"
                + "ELSE s.problem_resp_descrip\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_alergias IS true THEN 'SI'\n"
                + "WHEN s.problem_alergias IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_aler_descrip IS NULL THEN ''\n"
                + "ELSE s.problem_aler_descrip\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_neurologico IS true THEN 'SI'\n"
                + "WHEN s.problem_neurologico IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_neuro_descrip IS NULL THEN ''\n"
                + "ELSE s.problem_neuro_descrip\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_nerviosos IS true THEN 'SI'\n"
                + "WHEN s.problem_nerviosos IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN s.problem_nervi_descrip IS NULL THEN ''\n"
                + "ELSE s.problem_nervi_descrip\n"
                + "END)\n"
                + "FROM anamnesis anam\n"
...
//---------------------------------------CONSULTA PESTAÑA 12: RELACION FAMILIAR--------------------------------------------------
    ...
    public DefaultTableModel AnamnesisRF(String ID) {
        ...
        String sql = "SELECT\n"
                + "(CASE\n"
                + "WHEN rf.clima_familiar IS NULL THEN ''\n"
                + "ELSE rf.clima_familiar\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.relacion_padre IS NULL THEN ''\n"
                + "ELSE rf.relacion_padre\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.relacion_madre IS NULL THEN ''\n"
                + "ELSE rf.relacion_madre\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.relacion_hermanos IS NULL THEN ''\n"
                + "ELSE rf.relacion_hermanos\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.trabajo IS true THEN 'SI'\n"
                + "WHEN rf.trabajo IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.trabajo_decrip IS NULL THEN ''\n"
                + "ELSE rf.trabajo_decrip\n"
                + "END),\n"
                + "(CASE\n"
                + " WHEN 	rf.agresion_agresor IS true THEN 'SI'\n"
                + " WHEN 	rf.agresion_agresor IS false THEN 'NO'\n"
                + "ELSE ''\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.objeto_utilizado IS NULL THEN ''\n"
                + "ELSE rf.objeto_utilizado\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.obligacion_familiar IS NULL THEN ''\n"
                + "ELSE rf.obligacion_familiar\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.proyeccion_madre IS NULL THEN ''\n"
                + "ELSE rf.proyeccion_madre\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.necesidad_inmediata IS NULL THEN ''\n"
                + "ELSE rf.necesidad_inmediata\n"
                + "END),\n"
                + "(CASE\n"
                + "WHEN rf.agresion_frecuencia IS NULL THEN ''\n"
                + "ELSE rf.agresion_frecuencia\n"
                + "END)\n"
                + "FROM anamnesis anam\n"
        ...
        try {
            ...
            ResultSet res = conn.query(sql);
            String[] cabecera = {"Clima Familiar", "Relación Padre", "Relación Madre", "Relación Hermanos", "Trabaja",
                "Trabajo Descripción", "Agresor", "Objeto Utilizado", "Obligación Familiar", "Proyección Madre", "Necesidad Inmediata", "Frecuencia Agresión"};
            modelo.setColumnIdentifiers(cabecera);
            modelo.addRow(cabecera);
            while (res.next()) {
...
//---------------------------------------CONSULTA PESTAÑA 13: OBSERVACIONES---------------------------------------------------
    ...
    public DefaultTableModel AnamnesisO(String ID) {
        ...
        String sql = "SELECT \n"
                + "CASE\n"
                + "WHEN observaciones_generales  IS NULL THEN ''\n"
