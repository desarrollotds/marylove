...
public class Post_partoDB extends Post_parto {
    ...
    public Post_partoDB(int Post_parto_id, String Sensacion_post_parto, boolean Sexo_esperado, String reaccion_padre, String reaccion_madre, String alim_leche_master, String alim_leche_master_descrip, String problemas_succion, String destete_descripcion, int edad_sentar, int edad_caminar, int edad_primeras_palabras, int edad_aliment_solido, String dificultades_alimentacion, int veces_como_diario, String actitud_madre_no_come, String comer_solo_acompanado, boolean post_parto_estado, String edad_fin_leche_mater, boolean biberon, String biberon_edad_ini, String biberon_edad_fin) {
        super(Post_parto_id, Sensacion_post_parto, Sexo_esperado, reaccion_padre, reaccion_madre, alim_leche_master, alim_leche_master_descrip, problemas_succion, destete_descripcion, edad_sentar, edad_caminar, edad_primeras_palabras, edad_aliment_solido, dificultades_alimentacion, veces_como_diario, actitud_madre_no_come, comer_solo_acompanado, post_parto_estado, edad_fin_leche_mater, biberon, biberon_edad_ini, biberon_edad_fin);
    }
    ...
    public Post_partoDB(String Sensacion_post_parto, boolean Sexo_esperado, String reaccion_padre, String reaccion_madre, String alim_leche_master, String alim_leche_master_descrip, String problemas_succion, String destete_descripcion, int edad_sentar, int edad_caminar, int edad_primeras_palabras, int edad_aliment_solido, String dificultades_alimentacion, int veces_como_diario, String actitud_madre_no_come, String comer_solo_acompanado, String edad_fin_leche_mater, boolean biberon, String biberon_edad_ini, String biberon_edad_fin) {
        super(Sensacion_post_parto, Sexo_esperado, reaccion_padre, reaccion_madre, alim_leche_master, alim_leche_master_descrip, problemas_succion, destete_descripcion, edad_sentar, edad_caminar, edad_primeras_palabras, edad_aliment_solido, dificultades_alimentacion, veces_como_diario, actitud_madre_no_come, comer_solo_acompanado, edad_fin_leche_mater, biberon, biberon_edad_ini, biberon_edad_fin);
    }
