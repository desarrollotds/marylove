...
public class FormaAgregarArticulosVictima extends javax.swing.JFrame {

    public FormaAgregarArticulosVictima() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblCodVic = new javax.swing.JLabel();
    ...
    public JLabel getLblCodVic() {
        return lblCodVic;
    }

    public void setLblCodVic(JLabel lblCodVic) {
        this.lblCodVic = lblCodVic;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormaAgregarArticulosVictima().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblCodVic;
