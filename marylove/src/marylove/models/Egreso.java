...
public class Egreso extends Persona{
    ...
    public Egreso(int egreso_codigo, Date egreso_fecha, String egreso_situacion, FileInputStream fis, int longBytes, byte[] croquis, byte croquiz, String canton, String provincia, String per_refe_parentesco, String telefono, int personal_codigo, String direccion, String celarEgreso, String telefonoEgreso, String egresoEstaso) {
        ...
        this.celarEgreso = celarEgreso;
        this.telefonoEgreso = telefonoEgreso;
    ...
    public String getCelarEgreso() {
        return celarEgreso;
    }

    public void setCelarEgreso(String celarEgreso) {
        this.celarEgreso = celarEgreso;
    }

    public String getTelefonoEgreso() {
        return telefonoEgreso;
    }

    public void setTelefonoEgreso(String telefonoEgreso) {
        this.telefonoEgreso = telefonoEgreso;
    }
